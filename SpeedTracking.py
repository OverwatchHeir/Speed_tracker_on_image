...
pathCampus = "/Users/carlosdeantonio/Documents/Universidad/GPS/Practica 3/Python/campusSur.png"
pathInsia = "/Users/carlosdeantonio/Documents/Universidad/GPS/Practica 3/Python/insia.png"


class SpeedTracking(object):
    ...
    def set_pixel_position(self, Longitude, Latitude, imPath):
        ...
        try:
            ...
            while True:
                ...
                if data[0] == "$GPGGA":
                    ...
                    self.set_pixel_position(self.ACTUAL_LONGITUDE, self.ACTUAL_LATITUDE, pathInsia)
